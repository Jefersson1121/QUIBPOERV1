          ...
          <div className="hidden lg:block space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600">
                Accede a tu cuenta para explorar oportunidades o publicar tus servicios
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Perfil Verificado</h3>
                  <p className="text-gray-600">Amplía tu reputación con un perfil confiable</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Pagos Seguros</h3>
                  <p className="text-gray-600">Transacciones protegidas y metodología confiable</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Oportunidades Diarias</h3>
                  <p className="text-gray-600">Accede a nuevos proyectos y empleadores constantemente</p>
                </div>
              </div>
            </div>
          </div>
